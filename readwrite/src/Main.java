...
//      Process.setSynchronisationWrapper(new SolutionWithNoSynchronization());
   ...
   public Main(){
      Process p1 = new Process(1, "writer");
      Process p2 = new Process(2, "reader");
      Process p3 = new Process(3, "reader");
      Process p4 = new Process(4, "reader");
      Process p5 = new Process(5, "writer");
